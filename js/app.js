...
// show all product in UI & Retrieve each products and display in a card 
const showProducts = (products) => {
    ...
    for (const product of allProducts) {
      ...
      <div>
    <img class="product-image mb-4 mt-2" src=${product.image}></img>
      </div>
      <h4>${product.title}</h4>
      ...
      <span class="ms-3"><i class="fas fa-user-alt me-1"></i><span style="color:#7757FF">${product.rating.count}</span></span>
      </p>
...
const updateTaxAndCharge = () => {
    ...
    // const priceUpdated = parseFloat(priceConverted).toFixed(2);
